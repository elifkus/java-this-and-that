...
public class SolutionTest {
	...
	public void testIsRotation1() {
		...
		assertEquals(expected, Solution.isRotation(item1, item2));
	}
	...
	@Test
	public void testSpeedForIsRotation() {
		...
		for(int j=0; j<1000000; j++) {
			for (int i = 0; i<10; i=i+2) {
				assertEquals(i+":"+items[i] +"-"+items[i+1], results[i], Solution.isRotation(items[i], items[i+1]));
			}
		}
